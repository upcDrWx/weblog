...
import com.wx.weblog.admin.model.vo.tag.*;
import com.wx.weblog.admin.service.AdminTagService;
import com.wx.weblog.common.domain.dos.ArticleTagRelDO;
import com.wx.weblog.common.domain.dos.TagDO;
import com.wx.weblog.common.domain.mapper.ArticleTagRelMapper;
...
import com.wx.weblog.common.model.vo.SelectRspVO;
...
public class AdminTagServiceImpl extends ServiceImpl<TagMapper, TagDO> implements AdminTagService {
    ...
    public Response addTags(AddTagReqVO addTagReqVO) {
        // vo 转 do
        List<TagDO> tagDOS = addTagReqVO.getTags().stream().map(tagName -> TagDO.builder()
                .name(tagName.trim())
